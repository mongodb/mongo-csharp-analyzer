...
internal sealed class EFMqlGeneratorExecutor
{
    ...
    public EFMqlGeneratorExecutor(Type testClassType, LinqVersion maxSupportedLinqVersion, LinqVersion defaultLinqVersion)
    {
