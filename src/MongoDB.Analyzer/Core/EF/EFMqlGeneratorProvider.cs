...
internal static class EFMqlGeneratorProvider
{
    ...
    public static EFMqlGeneratorExecutor GetEFMqlGeneratorExecutor(
        ...
        LinqVersion defaultLinqVersion)
    {
        ...
        try
        {
            ...
            result = testClassType != null ? new EFMqlGeneratorExecutor(testClassType, driverLinqVersion, defaultLinqVersion) : null;
        }
        catch
        {
            result = null;
