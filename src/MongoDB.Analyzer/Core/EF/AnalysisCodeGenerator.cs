...
internal static class AnalysisCodeGenerator
{
    ...
    private static readonly EFMqlGeneratorTemplateBuilder.SyntaxElements s_mqlGeneratorSyntaxElements;
    private static readonly CSharpParseOptions s_parseOptions;

    static AnalysisCodeGenerator()
    {
        var mqlGeneratorSyntaxTree = GetCodeResource(ResourceNames.Linq.MqlGenerator);
        s_mqlGeneratorSyntaxElements = EFMqlGeneratorTemplateBuilder.CreateSyntaxElements(mqlGeneratorSyntaxTree);
    ...
    public static CompilationResult Compile(MongoAnalysisContext context, ExpressionsAnalysis linqExpressionAnalysis)
    {
        ...
        var isLinq3 = referencesContainer.Version >= EFAnalysisConstants.MinLinq3Version;
        var isLinq3Default = referencesContainer.Version >= EFAnalysisConstants.DefaultLinq3Version;
        ...
        var result = new CompilationResult(
            true,
            new EFMqlGeneratorExecutor(generatorType, isLinq3 ? LinqVersion.V3 : LinqVersion.V2, defaultLinqVersion),
    ...
    {
        var testCodeBuilder = new EFMqlGeneratorTemplateBuilder(s_mqlGeneratorSyntaxElements);
