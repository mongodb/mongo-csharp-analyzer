...
internal record JsonAnalysisTelemetry(
    ...
    long DurationMS)
{
    public static JsonAnalysisTelemetry Invalid = new(-1, -1, null, null, -1, -1, -1, -1);
    public static JsonAnalysisTelemetry Empty = new(0, 0, null, null, -1, -1, -1, -1);
