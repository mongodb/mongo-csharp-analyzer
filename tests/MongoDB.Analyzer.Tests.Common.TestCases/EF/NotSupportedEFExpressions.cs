...
{
    [NotSupportedEF("Byte array type is not supported by this version of the EF provider.")]
    [NotSupportedEF("Byte array type is not supported by this version of the EF provider.")]
    [NotSupportedEF("Byte array type is not supported by this version of the EF provider.")]
    [NotSupportedEF("Byte array type is not supported by this version of the EF provider.")]
    ...
    [NotSupportedEF("GroupBy is not supported by this version of the EF provider.")]
    [NotSupportedEF("GroupBy is not supported by this version of the EF provider.")]
    [NotSupportedEF("GroupBy is not supported by this version of the EF provider.")]
    [NotSupportedEF("GroupBy is not supported by this version of the EF provider.")]
    public void GroupBy()
