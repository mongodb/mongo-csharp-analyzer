...
namespace MongoDB.Analyzer.Tests.Common.TestCases.Poco
{
    ...
    {
        [NoDiagnostics]
        public void CustomDictionariesHolder()
        {
        }

        [NoDiagnostics]
        public void CustomEnumerableHolder()
        {
        }

        [NoDiagnostics]
        public void CustomHashSetsHolder()
        {
        }

        [NoDiagnostics]
        public void CustomLinkedListHolder()
        {
        }

        [NoDiagnostics]
        public void CustomListsHolder()
        {
        }

        [NoDiagnostics]
        public void CustomQueueHolder()
        {
        }

        [NoDiagnostics]
        public void CustomSortedDictionaryHolder()
        {
        }

        [NoDiagnostics]
        public void CustomStackHolder()
        {
        }

        [PocoJson("{ \"IntDictionary\" : { }, \"PesonsDictionary\" : { }, \"StringDictionary\" : { }, \"NestedDictionariesHolderDictionary\" : { }, \"IntIDictionary\" : null, \"NestedDictionariesHolderIDictionary\" : null }")]
        public void DictionariesHolder()
        {
        }
        ...
        [PocoJson("{ \"IntHashSet\" : null, \"PesonsHashSet\" : null, \"StringHashSet\" : null, \"NestedHashSetsHolderHashSet\" : null }")]
        public void HashSetHolder()
        {

        }

        [PocoJson("{ \"IntLinkedList\" : null, \"PesonsLinkedList\" : null, \"StringLinkedList\" : null, \"NestedLinkedListsHolderLinkedList\" : null }")]
        public void LinkedListHolder()
        {

        }

        [PocoJson("{ \"IntLinkedListNode\" : null, \"PesonsLinkedListNode\" : null, \"StringLinkedListNode\" : null, \"NestedLinkedListNodesHolderLinkedListNode\" : null }")]
        public void LinkedListNodeHolder()
        {
        ...
        [PocoJson("{ \"IntQueue\" : null, \"PesonsQueue\" : null, \"StringQueue\" : null, \"NestedQueuesHolderQueue\" : null }")]
        public void QueueHolder()
        {

        }

        [PocoJson("{ \"IntSortedDictionary\" : { }, \"PesonsSortedDictionary\" : { }, \"StringSortedDictionary\" : { }, \"NestedSortedDictionariesHolderSortedDictionary\" : { } }")]
        public void SortedDictionaryHolder()
        {

        }

        [PocoJson("{ \"IntStack\" : null, \"PesonsStack\" : null, \"StringStack\" : null, \"NestedStacksHolderStack\" : null }")]
        public void StackHolder()
        {
