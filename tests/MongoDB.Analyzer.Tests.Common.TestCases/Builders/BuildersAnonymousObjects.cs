...
namespace MongoDB.Analyzer.Tests.Common.TestCases.Builders
{
    public sealed class BuildersAnonymousObjects : TestCasesBase
    {
        ...
        [BuildersMQL("{ \"Scores\" : new { Item = value, IntField = 22 }.Item }")]
        ...
        [BuildersMQL("{ new { Field = \"IntList\" }.Field : new { Value = 22 }.Value }")]
        ...
        public void Filters()
        {
            ...
            _ = Builders<User>.Filter.AnyEq("Scores", new { Item = value, IntField = 22 }.Item);
            ...
            _ = Builders<ListsHolder>.Filter.AnyEq(new { Field = "IntList" }.Field, new { Value = 22 }.Value);
        ...
        public void Projections()
        {
            ...
            _ = Builders<User>.Projection.Combine(Builders<User>.Projection.Include(new { Field = "Age" }.Field), Builders<User>.Projection.Include(new { Field = "LastName" }.Field));
        }
        ...
        public void Sort()
        {
            _ = Builders<User>.Sort.Ascending(new { Address = "Address" }.Address).Descending(new { Name = "Name" }.Name);
            _ = Builders<User>.Sort.Combine(Builders<User>.Sort.Ascending(new { Address = "Address" }.Address), Builders<User>.Sort.Descending(new { Name = "Name" }.Name));
        }
        ...
        [BuildersMQL("{ \"$unset\" : { new { FieldUnset = \"Vehicle\", IntField = 22 }.FieldUnset : 1 } }")]
        ...
        [BuildersMQL("{ \"$bit\" : { new { Field = \"Age\", IntField = 22 }.Field : { \"or\" : new { AgeValue = 22 }.AgeValue } } }")]
        [BuildersMQL("{ \"$bit\" : { new { Field = \"Age\", IntField = 22 }.Field : { \"xor\" : new { AgeValue = 22 }.AgeValue } } }")]
        ...
        [BuildersMQL("{ \"$min\" : { new { Field = \"Data\", IntField = 22 }.Field : new { Value = 11 }.Value } }")]
        [BuildersMQL("{ \"$mul\" : { new { Field = \"Age\", IntField = 22 }.Field : new { Value = 23 }.Value } }")]
        [BuildersMQL("{ \"$pop\" : { new { Field = \"PesonsList\", IntField = 22 }.Field : -1 } }")]
        [BuildersMQL("{ \"$pop\" : { new { Field = \"PesonsList\", IntField = 22 }.Field : 1 } }")]
        ...
        public void Updates()
        {
            ...
            _ = Builders<Person>.Update.Unset(new { FieldUnset = "Vehicle", IntField = 22 }.FieldUnset);
            ...
            _ = Builders<User>.Update.BitwiseOr(new { Field = "Age", IntField = 22 }.Field, new { AgeValue = 22 }.AgeValue);
            _ = Builders<User>.Update.BitwiseXor(new { Field = "Age", IntField = 22 }.Field, new { AgeValue = 22 }.AgeValue);
            ...
            _ = Builders<TreeNode>.Update.Min(new { Field = "Data", IntField = 22 }.Field, new { Value = 11 }.Value);
            _ = Builders<User>.Update.Mul(new { Field = "Age", IntField = 22 }.Field, new { Value = 23 }.Value);

            _ = Builders<ListsHolder>.Update.PopFirst(new { Field = "PesonsList", IntField = 22 }.Field);
            _ = Builders<ListsHolder>.Update.PopLast(new { Field = "PesonsList", IntField = 22 }.Field);
        ...
        [BuildersMQL("{ new { Field = \"LastName\" }.Field : -1, new {Field = \"SiblingsCount\"}.Field : 1 }")]
        ...
        [BuildersMQL("{ new { Field = \"LicenseNumber\" }.Field : \"hashed\" }")]
        ...
        public void IndexKeys()
        {
            ...
            _ = Builders<Person>.IndexKeys.Descending(new { Field = "LastName" }.Field).Ascending(new {Field = "SiblingsCount"}.Field);
            ...
            _ = Builders<Vehicle>.IndexKeys.Hashed(new { Field = "LicenseNumber" }.Field);
            _ = Builders<Vehicle>.IndexKeys.GeoHaystack(new { Field = "LicenseNumber" }.Field);
            _ = Builders<Person>.IndexKeys.Combine(Builders<Person>.IndexKeys.Geo2D(new { Field = "Name", IntValue = 10, BoolValue = false, DoubleValue = 2.5 }.Field)
        ...
        public void Complex_anonymous_objects()
        {
            int value = 10;
